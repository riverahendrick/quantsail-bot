"""
Shared configuration models for API validation.
NOTE: This file is duplicated from services/engine/quantsail_engine/config/models.py
to ensure spec parity until a shared library is established.
"""
